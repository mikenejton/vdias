            ...
            if len(vitem_qs):
                ...
                if request.method == 'GET':
                    ...
                    if vitem.person:
                        ...
                        context['edit_link'] = [{'Агент': 'detailing-agent', 'Штат': 'detailing-staff', 'Ген. директор': 'detailing-ceo', 'Бенефициар': 'detailing-ben'}[vitem.person.role.role_name], vitem.person.id]
